...
import { Box, IconButton, Typography, useTheme, Dialog, DialogActions, DialogContent, DialogTitle,
          InputLabel, OutlinedInput, MenuItem, FormControl } from "@mui/material";
...
//**************************************************** */
  ...
  async function handleDeletefromShce(element) {
   ...
   for (let i = 0; i < targetEle_List.length; i++) {
      ...
      thisMode_OBJ.Events = thisMode_OBJ.Events.filter((ele)=>ele.Exercise.ExerciseTitle !== targetEle_List[i][0].exercise_name )
