...
const MixBroken= () => {
  ...
  for (let i = 0; i < Object.keys(drillDetail_OBJ_NEW).length; i++) {
    // var pre = "ModeName"
    // pre += `${i+1}`
    // console.log("add to mode",Object.values(drillDetail_OBJ_NEW));
    // console.log(Object.values(drillDetail_OBJ));
  }

  // MY_Modes_List_OBJ.push();
  ...
  async function formEC_row(ModeType) {
    var resultList = []
    ...
    for(let ele of newData){
      ...
      ROWS_cand.push({
        ...
        ExerciseID: ele.Exercise_ID,
        ExerciseTitle: ele.Name
